...
def verify_email_deliverability(email: str) -> bool:
    ...
    try:
        ...
        # Additional filter: skip very common generic prefixes that are often dead-ends
        generic_prefixes = ["info", "admin", "sales", "contact", "support", "office", "hello", "hr"]
...
def sanitize_name(name: str) -> str:
    ...
    # Handle names with initials (e.g. "J.P.")
    name = re.sub(r"\. ", "", name)
